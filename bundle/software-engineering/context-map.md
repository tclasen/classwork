...
A [context map](domain-driven-design.md) records how [bounded contexts](bounded-context.md) relate, including ownership, data or messages crossing a boundary, and translation or coordination. Common arrangements include a [shared kernel](shared-kernel.md), [published language](published-language.md), [conformist integration](conformist-integration.md), and [anti-corruption layer](anti-corruption-layer.md).[^source]
