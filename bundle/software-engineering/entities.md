...
An [entity](domain-driven-design.md) is a domain object defined primarily by identity that persists through changes to its attributes. Its behavior and lifecycle belong in the [domain model](domain-model.md), and it may participate in an [aggregate](aggregate.md). Use an entity when continuity matters more than structural equality.[^source]
